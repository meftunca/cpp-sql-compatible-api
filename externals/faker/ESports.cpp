...
#include "externals/faker/ESports.h"
 ...
 */
std::string Faker::ESports::player() { return parse("esport.players"); }
 ...
 */
std::string Faker::ESports::team() { return parse("esport.teams"); }
 ...
 */
std::string Faker::ESports::league() { return parse("esport.leagues"); }
 ...
 */
std::string Faker::ESports::event() { return parse("esport.events"); }
 ...
 */
std::string Faker::ESports::game() { return parse("esport.games"); }
