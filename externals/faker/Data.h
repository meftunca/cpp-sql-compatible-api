...
//
// Our JSON files are a direct translation from faker-ruby's YAML files. They
...
//					.male_first_name		-- an
//array of
// simple strings 					.female_first_nam		--
// an
// array of simple stringse 					.last_name
// -- an array of simple strings
//					.suffix					--
//an
// array of simple strings 					.prefix
// -- an array of simple strings .first_name
// -- an array of strings:
//"#{female_first_name}", "#{male_first_name}"
//					.name_with_middle		-- an
//array of strings with choices similar to first_name
// .name
//-- an array of strings with choices similar to first_name
//
...
#include "externals/faker/JSON_Serializable.h"
#include <map>
#include <string>
#include <vector>
...
/**
 * Handles the hard part of parsing our JSON files and returning useful
 * information.
 */
