 ...
 */
std::string Faker::Name::name() { return parse("name.name"); }
 ...
 */
std::string Faker::Name::first_name() { return parse("name.first_name"); }
 ...
 */
std::string Faker::Name::last_name() { return parse("name.last_name"); }
 ...
 */
std::string Faker::Name::prefix() { return parse("name.prefix"); }
 ...
 */
std::string Faker::Name::suffix() { return parse("name.suffix"); }

/**
 * Produces random initials.
 *
 * @param number [Integer] Number of digits that the generated initials should
 * have.
 *
 * ## Examples
