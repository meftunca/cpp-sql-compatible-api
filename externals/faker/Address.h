...
public:
  ...
  static std::string zip(const std::string state_abbreviation = "") {
    return zip_code(state_abbreviation);
  }
  static std::string postcode(const std::string state_abbreviation = "") {
    return zip_code(state_abbreviation);
  }
