...
#include "externals/faker/Number.h"
#include <cmath>
 ...
 *
 * @param digits [Integer] Number of digits that the generated number should
 * have.
 *
 * ## Examples
 ...
 *
 * @param l_digits [Integer] Number of digits that the generated decimal should
 * have to the left of the decimal point.
 * @param r_digits [Integer] Number of digits that the generated decimal should
 ...
 */
long Faker::Number::non_zero_digit() { return Base::randomNumber(1, 9); }
 ...
 */
long Faker::Number::digit() { return Base::randomNumber(0, 9); }
 ...
 *
 * ## Examples
 *   Faker::Number.normal(mean: 50, standard_deviation: 3.5)
 * *=> 47.14669604069156
 */
double Faker::Number::normal(double mean, double standard_deviation) {
  ...
  double firstRand = static_cast<double>(Base::randomNumber(0, 99999)) /
                     100000.0; // Never reach 1
  double secondRand = static_cast<double>(Base::randomNumber(0, 99999)) /
                      100000.0; // Never reach 1
